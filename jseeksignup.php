    ...
    <div class="wrapper fadeInDown ">
        <div class="formContent">
            ...
            <form action="" method="post" >
                <input type="text" id="fn" class="fadeIn third" name='fn' placeholder="First Name" pattern="[A-Za-z]{3,30}"  title="name should be at least 3 letters" required>
                    
                <input type="text" id="ln" class="fadeIn third" name="ln" placeholder="Last Name"  pattern="[A-Za-z]{3,30}"  title="name should be at least 3 letters" required>
                ...
                <input type="number" id="age" class="fadeIn third" name="age" placeholder="Age" required pattern="[0-9]{2}"
                 ...
                 <input type="text" id="phone" class="fadeIn third" name="phone" placeholder="Phone Number" pattern="[0]{1}[5]{1}[0-9]{8}"
